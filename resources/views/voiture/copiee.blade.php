          ...
          <form  enctype="multipart/form-data">
            ...
            <div><label class="spn text-left">Matricule</label><input type="text" name="matricule" id="matricule-add" class="txtmod">
                  <p class="error text-center alert alert-danger hidden"></p></div>
                     ...
                     <input type="hidden" name="created_at" id="created_at-add" class="txtmod">
...
var form_data = new FormData();
    ...
    $.ajax({
      ...
      "<td> <img src='/PhotosCar/"+form_data.get('matricule')+"/"+form_data.get('photo') +" ' width='100px' height='95px'> </td> </td>"+
      "<td>" + form_data.get('created_at')  + "</td>"+
      "<td>" + form_data.get('marque') + "</td>"+
 "<td> <span><a type='button' class='edit-modal'  data-matricule='" + data.matricule + "' data-modele= '"+ data.modele+ "' data-marque='" + data.marque + "' data-prix= '"+ data.prix+"' data-carburant='" + data.carburant + "' data-created_at='" + data.created_at + "' data-couleur='" + data.couleur + "' data-assurance='" + data.assurance + "' data-vignette='" + data.vignette + "' data-photo='" + data.photo + "'> <img src='img/ac1.png'></a></span> <span><a type='button' class='delete-modal' href='#' data-matricule='" + data.matricule + "' data-modele= '"+ data.modele+ "' data-marque='" + data.marque + "' data-prix= '"+ data.prix+"' data-carburant='" + data.carburant + "' data-created_at='" + data.created_at + "' data-couleur='" + data.couleur + "' data-assurance='" + data.assurance + "' data-vignette='" + data.vignette + "' data-photo='" + data.photo + "'> <img src='img/ac2.png'></a></span> <span><a type='button' class='show-modal' href='#'  data-matricule='" + data.matricule + "' data-modele= '"+ data.modele+ "' data-marque='" + data.marque + "' data-prix= '"+ data.prix+"' data-carburant='" + data.carburant + "' data-created_at='" + data.created_at + "' data-couleur='" + data.couleur + "' data-assurance='" + data.assurance + "'  data-vignette='" + data.vignette + "' data-photo='" + data.photo + "'> <img src='img/ac3.png'></a></span> </td>"+
      "</tr>");
        }
      },
    });
